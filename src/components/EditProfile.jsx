                ...
                <fieldset className="bg-base-300 border-base-300 rounded-box border p-6 space-y-4">
                    ...
                    <div className="form-control">
                        ...
                        <input
                            ...
                            className={`input input-bordered w-full ${errors.firstName ? 'input-error' : 'input-primary'
                                }`}
                    ...
                    <div className="form-control">
                        ...
                        <input
                            ...
                            className={`input input-bordered w-full ${errors.lastName ? 'input-error' : 'input-primary'
                                }`}
                    ...
                    <div className="form-control">
                        ...
                        <input
                            type="number"
                            placeholder="Age"
                            className={`input input-bordered w-full ${errors.age ? 'input-error' : 'input-primary'
                                }`}
                            {...register('age', {
                                required: true,
                                min: 1,
                    ...
                    <div className="form-control">
                        ...
                        <label
                            className={`input validator ${errors.photoUrl ? 'input-error' : ''
